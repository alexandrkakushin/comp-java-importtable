...
public class MainClass {
    ...
    private static Logger logger = Logger.getLogger("ru.ak.importable");
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (System.getProperty("java.util.logging.config.class") == null
            ...
            logger = Logger.getLogger("ru.ak.importable");
            ...
            try {                
                ...
                Handler handler = new FileHandler("%h/logs/importtable/importtable.log", 0, LOG_ROTATION_COUNT);
    ...
    private static boolean createLogDir() { 
        ...
        File logDir = new File(userHome + "/logs/importtable");
        
        return logDir.mkdirs();
    }
    
    private static boolean existLogDir() {
        File logDir = new File(System.getProperty("user.home") + "/logs/importtable/");
